...
const protocolRef = {
  ...
  labelsPresentation: [
    ...
    },
    {
      ...
      ressources: 'V_HVAC_SETPOINT_HEAT, V_HVAC_FLOW_STATE, V_TEMP, V_STATUS',
    },
    {
      Type: 'S_DISTANCE',
      value: 15,
    ...
    },
    {
      ...
      ressources: 'V_LEVEL (in dB), V_TRIPPED, V_ARMED',
    },
    {
      Type: 'S_VIBRATION',
      value: 34,
      ...
      ressources: 'V_LEVEL (vibration in Hz), V_TRIPPED, V_ARMED',
    },
    {
      Type: 'S_MOISTURE',
      value: 35,
  ...
  labelsSet: [
    ...
    },
    {
      ...
      sensorTypes: 'S_POWER, S_BINARY, S_DIMMER, S_RGB_LIGHT, S_RGBW_LIGHT',
    },
    {
      Type: 'V_KWH',
      value: 18,
    ...
    },
    {
      ...
      Unit: 'ms/cm',
      description: 'Water electric conductivity %u03BCS/cm (microSiemens/cm)',
      sensorTypes: 'S_WATER_QUALITY',
    },
    {
      Type: 'V_VAR',
